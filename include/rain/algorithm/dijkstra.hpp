...
namespace Rain::Algorithm {
	// Computes SSSP on directed weighted graph via Dijkstra's
	// in $O(N + M\log M)$, or until a target vertex is
	// reached. The provided graph must be simple and
	// connected, and edge weights must be non-negative.
	//
