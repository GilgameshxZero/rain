...
namespace Rain::Algorithm::Geometry {
	...
	class Rectangle {
		...
		inline PrecisionType height() const {
		...
		inline PrecisionType area() const {
		...
		inline Point<PrecisionType> clamp(
			Point<PrecisionType> const &point) const {
			return {
...
struct std::hash<
	...
	std::size_t operator()(
		Rain::Algorithm::Geometry::Rectangle<
			PrecisionType> const &rectangle) const {
		auto hash{Rain::Random::SplitMixHash<PrecisionType>()(
			rectangle.left)};
		Rain::Random::combineHash(
			hash,
			Rain::Random::SplitMixHash<PrecisionType>()(
				rectangle.top));
		Rain::Random::combineHash(
			hash,
			Rain::Random::SplitMixHash<PrecisionType>()(
