// The R/R Socket protocol implements Workers/Clients where
// Clients send Requests and Workers send Responses.
//
// The R/R Socket protocol is abstract and cannot be
// instantiated directly. Thus, with the exception of
// Socket, only interface implementations are provided.
#pragma once
