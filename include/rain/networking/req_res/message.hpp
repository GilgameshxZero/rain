...
namespace Rain::Networking::ReqRes {
	...
	class MessageInterface {
		...
		// send/recv-site; that is, pp-chains here will activate
		// with send/recv on any i/ostream.
...
// Free functions for inputting/outputting from a normal
// iostream. Should be overridden by pp-chain overloads, as
// these do not provide pp-chain benefits.
