...
namespace Rain::Networking {
	class MediaType {
		...
		// fromStr includes the type/subtype format but also the
		...
		public:
		// Only for MediaType, types not found will default to
		// octet-stream.
		...
		// parameter is copy-constructed since it is likely
		// light.
