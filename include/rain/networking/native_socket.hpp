// Includes all relevant headers to implement the
// NativeSocket type, which abstracts away the platform
// differences between naive socket handles.
#pragma once
...
namespace Rain::Networking {
	// Abstraction of platform socket. Error/invalid
	// differences between platforms.
#ifdef RAIN_PLATFORM_WINDOWS
	using NativeSocket = SOCKET;
	static NativeSocket const NATIVE_SOCKET_INVALID =
		INVALID_SOCKET;
