...
void assertEncodeDecodeFile(std::string const &name) {
	...
	std::cout << "Encode time: " << encodeTime << '.'
						<< std::endl;
	auto originalSize = std::filesystem::file_size(filePath);
	std::cout << "Encode speed: "
						<< static_cast<long double>(originalSize) /
			(1_zu << 20) /
			std::chrono::duration_cast<
				std::chrono::duration<long double>>(encodeTime)
				.count()
						<< "MB/s." << std::endl;
	...
	std::cout << "Decode time: " << decodeTime << '.'
						<< std::endl;
	auto encodedSize =
	...
	std::cout << "Decode speed: "
			...
			(1_zu << 20) /
			std::chrono::duration_cast<
				std::chrono::duration<long double>>(decodeTime)
				.count()
						<< "MB/s." << std::endl;
...
int main() {
	...
	assertEncodeDecode(
		...
		"volutpat maecenas volutpat blandit. Lacus viverra "
		"vitae congue eu "
		"consequat. Sed ullamcorper morbi tincidunt ornare "
		"massa eget egestas. "
		"Augue mauris augue neque gravida in. Imperdiet nulla "
		"malesuada "
		"pellentesque elit eget gravida. Mattis nunc sed "
		"blandit libero volutpat "
		"sed cras. Id neque aliquam vestibulum morbi blandit "
		"cursus. Ultricies "
		"lacus sed turpis tincidunt id aliquet risus. Aenean "
		"et tortor at risus "
		"viverra adipiscing at. Sodales neque sodales ut etiam "
		"sit. Sem nulla "
		"pharetra diam sit amet nisl suscipit. Tincidunt "
		"lobortis feugiat vivamus "
		"at augue. Dolor sit amet consectetur adipiscing elit "
		"duis tristique. "
		"Sapien et ligula ullamcorper malesuada. Tortor "
		"pretium viverra "
		"suspendisse potenti nullam. Ultricies mi eget mauris "
		"pharetra "
		"et.\r\n\r\n");
	assertEncodeDecode(
