...
int main() {
	...
	Console::cout(
		{.fgColor = Color::BLACK, .fgIntense = true},
		"BLACK INTENSE\n");
	Console::cout(
		{.fgColor = Color::RED, .fgIntense = true},
		"RED INTENSE\n");
	Console::cout(
		{.fgColor = Color::GREEN, .fgIntense = true},
		"GREEN INTENSE\n");
	Console::cout(
		{.fgColor = Color::YELLOW, .fgIntense = true},
		"YELLOW INTENSE\n");
	Console::cout(
		{.fgColor = Color::BLUE, .fgIntense = true},
		"BLUE INTENSE\n");
	Console::cout(
		{.fgColor = Color::MAGENTA, .fgIntense = true},
		"MAGENTA INTENSE\n");
	Console::cout(
		{.fgColor = Color::CYAN, .fgIntense = true},
		"CYAN INTENSE\n");
	Console::cout(
		{.fgColor = Color::WHITE, .fgIntense = true},
		"WHITE INTENSE\n");
	Console::cout(
		{.fgColor = Color::BLACK,
