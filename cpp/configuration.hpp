...
namespace Rain {
	class Configuration {
	 public:
		...
		Configuration &operator[](std::string key) { return *this->children[key]; }
		...
		std::string s() { return this->value; }
		int i() { return Rain::strToT<int>(this->value); }
	...
	// read parameters from standard parameter string, organized in lines
	// (terminated by \n) of key:value, possibly with whitespace inbetween
	// elements
